...
public class TestBase {
    ...
    static KosmoSHTTPClient clientAdmin;
    static KosmoSHTTPClient clientUser;


    static KosmoSHTTPClient clientFakeUser;
    static String baseUrl = "";
    @SuppressFBWarnings("MS_SHOULD_BE_FINAL")
    static KosmoSHTTPClient clientNoLogin;
    ...
    public static void setup() {
        ...
        try {
            ...
            clientAdmin = new KosmoSHTTPClient(baseUrl, "admin", StringFunctions.generateRandomKey());
            clientUser = new KosmoSHTTPClient(baseUrl, "user", StringFunctions.generateRandomKey());


            clientFakeUser = new KosmoSHTTPClient(baseUrl, "fakeuser2", "test");
            clientNoLogin = new KosmoSHTTPClient(baseUrl, null, null);
