...
@Extension
@ApiEndpoint(
        path = "/kiosk/listObjects",
        userLevel = 1
)
public class KioskListObjects extends KosmoSAuthedServlet implements ExtensionPoint {


    private final KioskController kiosk;

    public KioskListObjects(KosmoSWebServer webServer, IController controller, int level) {
    ...
    @Operation(
            ...
            description = "Get the defined objects for the kiosk UI",
            summary = "get objects",
    ...
    public void get(KosmoSHttpServletRequest request, HttpServletResponse response)
        ...
        sendJSON(request, response, kiosk.getObjects());
